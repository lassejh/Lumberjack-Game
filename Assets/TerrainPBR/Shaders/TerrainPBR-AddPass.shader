Shader "Hidden/Nature/Terrain/Terrain PBR-AddPass" 
{
	Properties 
	{
		...
		[HideInInspector] _BasemapDistance ("BaseMap Distance", Float) = 1000
		[HideInInspector] _FadeLength ("Fade Lenght", Float) = 100			
	}
	...
	SubShader 
	{
		...
		#pragma surface surf Standard vertex:vert decal:add
